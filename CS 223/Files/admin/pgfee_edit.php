...
require('includes/connection.php');
	...
	$get_pro1 = "SELECT*FROM pgfeestructure WHERE catagory = 'GEN'";
	...
	$get_pro2 = "SELECT*FROM pgfeestructure WHERE catagory = 'OBC'";
	...
	$get_pro3 = "SELECT*FROM pgfeestructure WHERE catagory = 'SC/ST'";
...
-->
   <tr  >
	        ...
	        <div class="col-md-2"> 
	        <td   style="text-align:center;"><input type="number" size = "10" name="input_11" value= "<?php echo $pro_11 ;?>" ></td>
	        </div>
	        <div class="col-md-2"> 
	        <td   style="text-align:center;"><input type="number"  size = "10" name="input_12" value= "<?php echo $pro_12 ;?>" ></td>
	        </div>
	        <div class="col-md-2"> 
	        <td  style="text-align:center;"><input type="number"  size = "10" name="input_13" value= "<?php echo $pro_13 ;?>" ></td>
	        </div>
	        <div class="col-md-2"> 
	        <td    style="text-align:center;"><input type="number"  size = "10" name="input_14" value= "<?php echo $pro_14 ;?>"></td>
	        </div>
	        <div class="col-md-2"> 
	        <td   style="text-align:center;"><input type="number"  size = "10" name="input_15" value= "<?php echo $pro_15 ;?>"></td>
	        </div>    
	      </tr>	
	      ...
	      <tr  >
	        ...
	        <div class="col-md-2"> 
	        <td   style="text-align:center;"><input type="number" size = "10" name="input_21" value= "<?php echo $pro_21 ;?>" ></td>
	        </div>
	        <div class="col-md-2"> 
	        <td   style="text-align:center;"><input type="number"  size = "10" name="input_22" value= "<?php echo $pro_22 ;?>" ></td>
	        </div>
	        <div class="col-md-2"> 
	        <td  style="text-align:center;"><input type="number"  size = "10" name="input_23" value= "<?php echo $pro_23 ;?>" ></td>
	        </div>
	        <div class="col-md-2"> 
	        <td    style="text-align:center;"><input type="number"  size = "10" name="input_24" value= "<?php echo $pro_24 ;?>"></td>
	        </div>
	        <div class="col-md-2"> 
	        <td   style="text-align:center;"><input type="number"  size = "10" name="input_25" value= "<?php echo $pro_25 ;?>"></td>
	        </div>   
	      </tr>	
	      ...
	      <tr  >
	        ...
	        <div class="col-md-2"> 
	        <td   style="text-align:center;"><input type="number" size = "10" name="input_31" value= "<?php echo $pro_31 ;?>" ></td>
	        </div>
	        <div class="col-md-2"> 
	        <td   style="text-align:center;"><input type="number"  size = "10" name="input_32" value= "<?php echo $pro_32 ;?>" ></td>
	        </div>
	        <div class="col-md-2"> 
	        <td  style="text-align:center;"><input type="number"  size = "10" name="input_33" value= "<?php echo $pro_33;?>" ></td>
	        </div>
	        <div class="col-md-2"> 
	        <td    style="text-align:center;"><input type="number"  size = "10" name="input_34" value= "<?php echo $pro_34 ;?>"></td>
	        </div>
	        <div class="col-md-2"> 
	  ...
	  if(isset($_POST['insert_post']))
			{
					...
					$update_fee1= "UPDATE pgfeestructure SET Y_2011 = '$ug_11', Y_2012 = '$ug_12',Y_2013 = '$ug_13', Y_2014 = '$ug_14', Y_2015 = '$ug_15' WHERE catagory='GEN'";  
					//echo $update_fee1;
					$update_fee2= "UPDATE pgfeestructure SET Y_2011 = '$ug_21', Y_2012 = '$ug_22',Y_2013 = '$ug_23', Y_2014 = '$ug_24', Y_2015 = '$ug_25' WHERE catagory='OBC'";
					
					$update_fee3= "UPDATE pgfeestructure SET Y_2011 = '$ug_31', Y_2012 = '$ug_32',Y_2013 = '$ug_33', Y_2014 = '$ug_34', Y_2015 = '$ug_35' WHERE catagory='SC/ST'";
					...
					if($fee_updat1){
						if ($fee_updat2){
							if($fee_updat3){
								echo "<script> alert('PG Fees has been Updated')</script>";
